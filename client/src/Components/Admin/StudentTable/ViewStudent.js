...
//     axios.get(`${API}/api/student/view-student/${id}`, {
//       headers: {
...
//           <Col className="text-center">
//             <p className="font-weight-bold">
//               Student DOB: {studentData.data.dob}
//             </p>
//           </Col>
//         </Row>
...
//                   <td className={displaysubject(studentData.data.subject1)}>{studentData.data.subject1 >= 35 ? 'Pass' : 'Fail'}</td>
//                 </tr>
//                 <tr>
//                   <td>2</td>
//                   <td>Subject 2</td>
...
//                   <td>{studentData.data.subject2 >= 35 ? 'Pass' : 'Fail'}</td>
//                 </tr>
//                 <tr>
//                   <td>3</td>
//                   <td>Subject 3</td>
...
//                   <td className={displaysubject(studentData.data.subject3)}>{studentData.data.subject3 >= 35 ? 'Pass' : 'Fail'}</td>
//                 </tr>
//                 <tr>
//                   <td>4</td>
//                   <td>Subject 4</td>
...
//                   <td>{studentData.data.subject4 >= 35 ? 'Pass' : 'Fail'}</td>
//                 </tr>
//                 <tr>
//                   <td>5</td>
//                   <td>Subject 5</td>
...
//                   <td>{studentData.data.subject5 >= 35 ? 'Pass' : 'Fail'}</td>
//                 </tr>
//               </tbody>
//             </Table>
//           </Col>
...
//                 <tr>
//                   <th>Result</th>
//                   <td className={displayresult(studentData.data.Result)}>{studentData.data.Result}</td>
//                 </tr>
//               </thead>
//             </Table>
//           </Col>
